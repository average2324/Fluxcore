...
class GameScreen(
    ...
    private fun createProceduralShipTexture(index: Int): Texture {
        ...
        val corePalette = listOf(
            ...
            Color.valueOf("FF6A9D"),
            Color.valueOf("7AB0FF"),
            Color.valueOf("6CFFEA"),
            Color.valueOf("E3FF78"),
            Color.valueOf("FF9E6C"),
            Color.valueOf("FF8FF1"),
            Color.valueOf("9BB8FF")
        )
        val accentPalette = listOf(
            Color.valueOf("D8FBFF"),
            Color.valueOf("FFE0C1"),
            Color.valueOf("D6FFE3"),
            Color.valueOf("FFF4D3"),
            Color.valueOf("FFDCEB"),
            Color.valueOf("E7EEFF"),
            Color.valueOf("D6FFF9"),
            Color.valueOf("F5FFD7"),
            Color.valueOf("FFE7DA"),
            Color.valueOf("F5DFFF"),
            Color.valueOf("EAF1FF")
        )
        ...
        val lineColor = Color(0.05f, 0.1f, 0.19f, 0.86f)
        val glowColor = accent.cpy().mul(1f, 1f, 1f, 0.94f)

        fun hull(noseX: Int, tailX: Int, topY: Int, bottomY: Int) {
            pixmap.fillTriangle(noseX, midY, tailX, topY, tailX, bottomY)
        }

        fun wings(frontX: Int, rootX: Int, lift: Int, waistX: Int, waistInset: Int = 8) {
            pixmap.fillTriangle(frontX, midY, rootX, midY - lift, waistX, midY - waistInset)
            pixmap.fillTriangle(frontX, midY, rootX, midY + lift, waistX, midY + waistInset)
        }

        fun canopy(x: Int, radius: Int) {
            pixmap.setColor(glowColor)
            pixmap.fillCircle(x, midY, radius)
        }

        pixmap.setColor(core)
        when (index.coerceIn(0, 10)) {
            0 -> {
                hull(178, 24, 42, 86)
                wings(146, 82, 26, 48, 8)
                pixmap.fillTriangle(118, midY, 66, 44, 66, 84)
                pixmap.fillTriangle(88, midY, 34, 54, 34, 74)
            }
            1 -> {
                hull(174, 26, 36, 92)
                wings(144, 86, 36, 54, 10)
                pixmap.fillTriangle(122, midY, 72, 30, 72, 98)
            }
            2 -> {
                hull(168, 30, 38, 90)
                pixmap.fillTriangle(142, midY, 88, 26, 88, 102)
                pixmap.fillTriangle(118, midY, 48, 42, 48, 86)
                pixmap.fillTriangle(88, midY, 28, 54, 28, 74)
            }
            3 -> {
                hull(176, 20, 42, 86)
                wings(134, 94, 40, 70, 12)
                pixmap.fillTriangle(110, 44, 52, 26, 62, 56)
                pixmap.fillTriangle(110, 84, 52, 102, 62, 72)
            }
            4 -> {
                hull(170, 24, 34, 94)
                wings(124, 60, 30, 44, 6)
                pixmap.fillTriangle(160, midY, 98, 48, 98, 80)
                pixmap.fillTriangle(90, midY, 38, 38, 38, 90)
            }
            5 -> {
                hull(170, 34, 40, 88)
                wings(154, 110, 36, 82, 10)
                pixmap.fillTriangle(136, midY, 92, 30, 92, 98)
                pixmap.fillTriangle(114, midY, 58, 46, 58, 82)
            }
            6 -> {
                hull(180, 28, 44, 84)
                wings(126, 76, 34, 48, 8)
                pixmap.fillTriangle(104, midY, 56, 34, 56, 94)
                pixmap.fillTriangle(70, midY, 26, 52, 26, 76)
            }
            7 -> {
                hull(170, 22, 40, 88)
                wings(156, 112, 24, 78, 8)
                pixmap.fillTriangle(126, midY, 74, 28, 74, 100)
                pixmap.fillTriangle(90, midY, 34, 48, 34, 80)
            }
            8 -> {
                hull(176, 24, 38, 90)
                wings(140, 84, 42, 56, 11)
                pixmap.fillTriangle(118, 34, 52, 44, 84, midY)
                pixmap.fillTriangle(118, 94, 52, 84, 84, midY)
            }
            9 -> {
                hull(168, 20, 42, 86)
                wings(132, 70, 26, 40, 7)
                pixmap.fillTriangle(160, midY, 104, 48, 104, 80)
                pixmap.fillTriangle(120, midY, 58, 30, 58, 98)
            }
            else -> {
                hull(178, 26, 36, 92)
                wings(146, 96, 32, 68, 9)
                pixmap.fillTriangle(122, midY, 64, 26, 64, 102)
                pixmap.fillTriangle(90, midY, 34, 44, 34, 84)
            }
        }
        ...
        when (index.coerceIn(0, 10)) {
            0 -> {
                canopy(146, 8)
                pixmap.fillTriangle(152, midY, 112, 56, 112, 72)
            }
            1 -> {
                canopy(136, 7)
                pixmap.fillTriangle(146, midY, 112, 52, 112, 76)
            }
            2 -> {
                canopy(132, 7)
                pixmap.fillTriangle(144, midY, 100, 50, 100, 78)
            }
            3 -> {
                canopy(140, 7)
                pixmap.fillTriangle(142, midY, 104, 54, 104, 74)
            }
            4 -> {
                canopy(138, 8)
                pixmap.fillTriangle(146, midY, 112, 54, 112, 74)
            }
            5 -> {
                canopy(142, 8)
                pixmap.fillTriangle(148, midY, 110, 50, 110, 78)
            }
            6 -> {
                canopy(144, 8)
                pixmap.fillTriangle(150, midY, 114, 56, 114, 72)
            }
            7 -> {
                canopy(146, 8)
                pixmap.fillTriangle(152, midY, 120, 54, 120, 74)
            }
            8 -> {
                canopy(140, 7)
                pixmap.fillTriangle(146, midY, 108, 50, 108, 78)
            }
            9 -> {
                canopy(130, 7)
                pixmap.fillTriangle(142, midY, 96, 52, 96, 76)
            }
            else -> {
                canopy(138, 8)
                pixmap.fillTriangle(150, midY, 108, 54, 108, 74)
            }
        }
        ...
        when (index.coerceIn(0, 10)) {
            0 -> {
                pixmap.drawLine(52, midY, 170, midY)
                pixmap.drawLine(84, midY - 8, 154, midY - 3)
                pixmap.drawLine(84, midY + 8, 154, midY + 3)
            }
            5 -> {
                pixmap.drawLine(60, midY, 166, midY)
                pixmap.drawLine(88, midY - 12, 154, midY - 6)
                pixmap.drawLine(88, midY + 12, 154, midY + 6)
                pixmap.drawLine(64, midY - 2, 98, midY - 14)
                pixmap.drawLine(64, midY + 2, 98, midY + 14)
            }
            else -> {
                pixmap.drawLine(48, midY, 166, midY)
                pixmap.drawLine(78, midY - 9, 146, midY - 4)
                pixmap.drawLine(78, midY + 9, 146, midY + 4)
            }
        }
